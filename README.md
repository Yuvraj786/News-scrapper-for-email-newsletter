# The News-scrapper
 The News-scrapper is a python program to send Email of latest news & top-stories scrapped from various sites, It uses geckodriver, BeautifulSoup to access the websites.
